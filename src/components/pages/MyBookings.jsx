...
const MyBookings = () => {
    ...
    return (
        <div className="py-18 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
            <Title title='My Bookings' subTitle='Easily manage your past, current, and upcoming hotel reservations in oneplace.
            Plan your trips seamlessly with just a few clicks.'/>
            
            <div className="max-w-6xl mt-8 w-full text-gray-800">
                <div className="pl-5 hidden md:grid md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 font-medium text-base py-3">
                        ...
                        <div className="flex flex-col md:flex-row">
                            ...
                            <div className="flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4">
                                ...
                                <div className="flex items-center gap-1 text-sm text-gray-500">
                                    <img src={assets.locationIcon} alt="hotel-img" className="min-md:w-4 rounded shadow object-cover" />
                                    <span>{bookings.hotel.address}</span>
                                </div>
                                <div className="flex items-center gap-1 text-sm text-gray-500">
                                    <img src={assets.guestsIcon} alt="guests-icon" className="min-md:w-4 rounded shadow object-cover" />
