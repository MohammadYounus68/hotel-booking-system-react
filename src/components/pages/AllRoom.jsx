...
import { assets, facilityIcons, roomsDummyData, testimonials } from './../../assets/assets';
import { useNavigate } from 'react-router-dom';
import StartRating from './../StartRating';

//chack box components
                        ...
                        <div className='md:w-1/2 flex flex-col gap-2'>
                            ...
                            <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                                {room.amenities.map((item,index) => (
                                    <div className='flex item-center gap-2 px-3 py-2 rounded-lg bg=[#f5f4ff]'>
                                        <img key={index} src={facilityIcons[item]} alt="item" className='w-5 h-6'/>
