...
const DashBoard = () => {
    ...
    return (
        <div>
            ...
            revenue-all in one place. Stay updated with real-timeinsights to ensure smooth operations.'/>
            <div className='flex gap-4 my-8'>
                ...
                {/* Total Revenue--- */}
                <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
                    <img src={assets.totalRevenueIcon} alt="totalBookingIcon" className='max-sm:hidden h-10'/>
                    <div className='flex flex-col sm:ml-4 font-medium'>
                    ...
                    <table className='w-full'>
                        <thead className='bg-gray-50'>
                            <tr>
                                ...
                                <th className='py-3 px-4 text-gray-800 font-medium text-center'>Total Amount
                                </th>
